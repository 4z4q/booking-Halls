...
export default function NetworkDashboard() {
  ...
  const networkName = "شبكة_المنزل";
  const deviceName = "جهاز الكمبيوتر المحمول";
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setUploadSpeed((prev) =>
        Math.min(100, Math.max(40, prev + (Math.random() * 8 - 4)))
      );
      setSignalStrength((prev) =>
        Math.min(100, Math.max(65, prev + (Math.random() * 6 - 3)))
      );
    }, 3000);
      ...
      <Card className="shadow-lg border-slate-200 dark:border-slate-800">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium">
                  {downloadSpeed.toFixed(1)} ميجابت/ثانية
                </span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium">
                  {uploadSpeed.toFixed(1)} ميجابت/ثانية
                </span>
              </div>
          ...
          <div className="grid grid-cols-2 gap-3 pt-2">
            ...
            <Button
              variant="outline"
              className="w-full text-red-600 bg-red-100 border-red-200 hover:bg-red-200"
              onClick={handleLogout}
            >
