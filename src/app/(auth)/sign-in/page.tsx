  ...
  return (
    ...
    >
      <Card className="border-slate-200 shadow-lg dark:border-slate-800 w-full max-w-md">
          ...
          <form>
            <div className="grid gap-4 ">
              <div className="space-y-2">
                <Label htmlFor="networkCode">رقم الجوال أو الايميل</Label>
                <Input
                  id="networkCode"
              ...
              <div className="space-y-2">
                <Label htmlFor="networkCode"> كلمة المرور</Label>
                <Input
                  id="networkCode"
        ...
        <CardFooter className="flex  flex-col gap-4 justify-center border-t px-6 py-4">
