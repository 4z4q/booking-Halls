                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={location} className="flex items-center space-x-2">
                      ...
                      <Label className="pr-1" htmlFor={`location-mobile-${location}`}>
                        {location}
                      </Label>
                    </div>
                  ))}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-muted-foreground">0 ريال</span>
                    <span className="text-sm text-muted-foreground">2000 ريال</span>
                  </div>
                  <Slider defaultValue={[0, 2000]} max={2000} step={100} />
                  <div className="flex items-center space-x-2">
                    <Input type="number" placeholder="الحد الأدنى" className="h-8" />
                    <span className="text-muted-foreground">-</span>
                    <Input type="number" placeholder="الحد الأعلى" className="h-8" />
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={amenity} className="flex items-center space-x-2">
                      ...
                      <Label className="pr-1" htmlFor={`amenity-mobile-${amenity}`}>
                        {amenity}
                      </Label>
                    </div>
                  ))}
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={location} className="flex items-center space-x-2">
                ...
                <Label className="pr-1" htmlFor={`location-${location}`}>
                  {location}
                </Label>
              </div>
            ))}
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={amenity} className="flex items-center space-x-2">
                ...
                <Label className="pr-1" htmlFor={`amenity-${amenity}`}>
                  {amenity}
                </Label>
              </div>
            ))}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center">
                        ...
                        <span className="text-xs text-muted-foreground">/في اليوم</span>
                      </div>
                      {category.toLowerCase() === "halls" && (
                        <div className="flex items-center">
